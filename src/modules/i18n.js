export function initI18n() {
    ...
    const translations = {
        fr: {
            ...
            'filter-viz': 'Dataviz',
            'demo-cleanmatch-title': 'CleanMatch',
            'demo-cleanmatch-desc': 'L\'outil d\'aide à la déduplication intelligent. Identifiez les doublons, validez les clusters et exportez des données propres en quelques clics.',
        ...
        en: {
            ...
            'filter-viz': 'Dataviz',
            'demo-cleanmatch-title': 'CleanMatch',
            'demo-cleanmatch-desc': 'The intelligent deduplication assistant. Identify duplicates, validate clusters, and export clean data in just a few clicks.',
            'demo-devtool-title': 'Dev Tooling Assistant',
